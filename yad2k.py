...
from tensorflow.python.keras.layers import (Conv2D, GlobalAveragePooling2D, Input, Lambda,
                          MaxPooling2D)
...
from keras_yolo import (space_to_depth_x2, space_to_depth_x2_output_shape)
